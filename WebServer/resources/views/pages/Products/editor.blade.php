...
<div class="card">
  <div class="card-header">
    {{$formType == 'save' ? 'إنشاء' : 'تعديل'}} منتج
  </div>
  <div class="card-body">
    <form action="{{$formAction}}" method="post" enctype='multipart/form-data'>
      ...
      <div class="row">
        ...
        <div class="col-3 mb-3">
          ...
          <input type="text" class="form-control" name="description" id="description" value="{{isset($row) ? $row->description : ''}}" required>
        </div>

        <div class="col-3 mb-3">
          <label for="price" class="form-label">السعر <span class="text-danger">*</span></label>
          <input type="number" class="form-control" name="price" id="price" value="{{isset($row) ? $row->price : ''}}" required>
        </div>
